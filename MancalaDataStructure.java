...
public class MancalaDataStructure {
    ...
    //Get the iterator Position needed for kalah rules and ayo rules
    public Countable iteratorPosition() {
        return data.get(iteratorPos);
    }

    public int returnPositionStore(){
        return iteratorPos;
    }
    ...
    public int getIteratorPosition(){
        if (iteratorPos == 13) {
            return 1;
        } else if (iteratorPos >= 6) {
            return iteratorPos % 6 + 1;
        }
